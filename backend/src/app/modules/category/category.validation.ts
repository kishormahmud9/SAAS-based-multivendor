...
const createCategory = z.object({
  body: z.object({
    ...
    navStatus: z.preprocess((val) => val === 'true' || val === true, z.boolean()).default(false),
    isHomepageView: z.preprocess((val) => val === 'true' || val === true, z.boolean()).default(false),
...
const updateCategory = z.object({
  body: z.object({
    ...
    navStatus: z.preprocess((val) => val === 'true' || val === true, z.boolean()).optional(),
    isHomepageView: z.preprocess((val) => val === 'true' || val === true, z.boolean()).optional(),
    metaTitle: z.string().max(70, 'Meta title too long').optional(),
    metaDesc: z.string().max(160, 'Meta description too long').optional(),
  }),
});
