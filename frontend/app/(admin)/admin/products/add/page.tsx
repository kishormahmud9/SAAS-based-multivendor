        ...
        <div className="w-full space-y-6">
            ...
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2">Create a new product for your store</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 space-y-6 transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Regular Price *</label>
                            <input
                                type="number"
                                step="0.01"
                                required
                ...
                {/* Features */}
                <div className="space-y-4">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">Features</h3>
                    ...
                    <label className="flex items-center space-x-3 cursor-pointer">
                        ...
                        />
                        <span className="text-gray-700 dark:text-gray-300 font-medium">Mark as Featured Product</span>
                    </label>
                </div>
                ...
                <div className="flex space-x-4 pt-6 border-t dark:border-gray-700">
                    ...
                    >
                        <span>{submitting ? (uploading ? "Uploading..." : "Creating...") : "Create Product"}</span>
                    </button>
                </div>
            </form>
