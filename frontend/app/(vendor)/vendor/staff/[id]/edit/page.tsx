...
const MOCK_STAFF = [
    { id: "1", name: "Jessica Alba", email: "jessica@store.com", role: "1", overrides: ["products.view", "products.add"] },
]
...
export default function EditStaffPage() {
    ...
    useEffect(() => {
        ...
        if (staff) {
            ...
            setRole(staff.role)
            if (staff.overrides.length > 0) {
                setShowOverrides(true)
                setOverrides(staff.overrides)
            }
        }
    }, [id])
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 font-medium mt-1">Modify team member details and update their access permissions.</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
                            <div className="p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50 rounded-3xl flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-blue-700/70 dark:text-blue-300/70 font-medium mt-1">Selecting permissions here will override the defaults set by the chosen role.</p>
                                </div>
                            </div>
                            <PermissionMatrix 
