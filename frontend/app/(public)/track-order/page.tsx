...
export default function TrackOrderPage() {
    ...
    if (isTracking) {
        return (
            <div className="min-h-screen bg-gray-50/50 dark:bg-gray-950 py-12 px-6">
                <div className="container mx-auto max-w-5xl animate-in fade-in slide-in-from-bottom-8 duration-700">
                    {/* Header Action */}
                    <div className="flex items-center justify-between mb-10">
                        <button 
                            onClick={() => setIsTracking(false)}
                            className="flex items-center gap-2 text-[10px] font-black text-gray-400 hover:text-orange-600 transition-all uppercase tracking-widest bg-white dark:bg-gray-900 px-4 py-2 rounded-full border border-gray-100 dark:border-gray-800 shadow-sm"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            <div className="relative overflow-hidden bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl rounded-[2.5rem] border border-white dark:border-gray-800 p-8 md:p-10 shadow-2xl shadow-gray-200/50 dark:shadow-none">
                                ...
                                <div className="relative space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pt-8 border-t border-gray-100 dark:border-white/5">
                                        <div>
                                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Expected Delivery</p>
                                            <p className="text-sm font-black text-gray-900 dark:text-white">{mockOrder.estimatedDelivery}</p>
                                        </div>
                                        <div>
                                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Order Date</p>
                                            <p className="text-sm font-black text-gray-900 dark:text-white">{mockOrder.placedAt}</p>
                                        </div>
                            ...
                            {/* Tracking Stepper */}
                            <div className="bg-white dark:bg-gray-900/50 rounded-[2.5rem] p-8 md:p-10 border border-gray-100 dark:border-gray-800">
                                ...
                                <div className="space-y-12 relative">
                                    <div className="absolute left-[21px] top-2 bottom-2 w-0.5 bg-gray-100 dark:bg-gray-800"></div>
                                    {steps.map((step, idx) => (
                                        <div key={idx} className="flex items-start gap-8 relative group">
                                            <div className={`w-11 h-11 rounded-2xl flex items-center justify-center relative z-10 transition-all duration-500 border-4 border-white dark:border-gray-900 ${
                                            ...
                                            <div className="flex flex-col flex-1 pb-4 border-b border-gray-50 dark:border-white/5 last:border-0">
                                                <div className="flex items-center justify-between mb-1">
                                                    <h4 className={`font-black tracking-tight text-base ${
                                                        step.status === "upcoming" ? "text-gray-400" : "text-gray-900 dark:text-white"
                                                    }`}>
                                                        {step.name}
                                                    </h4>
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            <div className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 dark:border-gray-800 p-8 shadow-xl shadow-gray-200/50 dark:shadow-none">
                                ...
                                <div className="space-y-6">
                                    {mockOrder.items.map((item, idx) => (
                                        <div key={idx} className="flex gap-5 group">
                                            <div className="relative w-20 h-20 rounded-[1.5rem] overflow-hidden flex-shrink-0 border border-gray-100 dark:border-gray-800 bg-gray-50 p-2">
                                            ...
                                            <div className="flex flex-col justify-center">
                                                <h5 className="font-black text-gray-900 dark:text-white text-xs leading-5 mb-1">{item.name}</h5>
                                                ...
                                                <div className="mt-2 flex items-center gap-3">
                                                    ...
                                                    <span className="text-xs font-black text-gray-900 dark:text-white">${item.price.toFixed(2)}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
                                    <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-950 p-4 rounded-2xl">
                                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Total Value</span>
                                        <span className="text-xl font-black text-gray-900 dark:text-white tracking-tighter">${mockOrder.total.toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>

                            {/* Shipping Information */}
                            <div className="bg-gray-900 dark:bg-gray-800 rounded-[2rem] p-8 text-white shadow-2xl overflow-hidden relative group">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button className="py-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[1.5rem] font-black uppercase tracking-widest text-[9px] flex items-center justify-center gap-2 hover:border-orange-600/30 transition-all active:scale-95 shadow-lg shadow-gray-200/50 dark:shadow-none">
                                    <MessageCircle size={14} className="text-orange-600" /> Support
                                </button>
                                <Link href="/returns" className="py-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[1.5rem] font-black uppercase tracking-widest text-[9px] flex items-center justify-center gap-2 hover:border-orange-600/30 transition-all active:scale-95 shadow-lg shadow-gray-200/50 dark:shadow-none">
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-orange-50/10 via-transparent to-transparent">
            <div className="w-full max-w-xl text-center space-y-8">
                <div className="space-y-4">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-500 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <Package size={12} />
                        <span className="text-[10px] font-black uppercase tracking-widest">Live Tracking</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tighter animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                        Track Your Order
                    </h1>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl shadow-gray-100/50 dark:shadow-none p-2 animate-in fade-in zoom-in duration-700 delay-300 border border-gray-100 dark:border-gray-800 overflow-hidden">
                    <form onSubmit={handleTrack} className="flex flex-col md:flex-row items-center gap-2">
                        <div className="relative flex-1 w-full group">
                            ...
                            <input
                                ...
                                className="w-full pl-16 pr-6 py-5 bg-transparent outline-none font-black text-lg text-gray-900 dark:text-white placeholder:text-gray-200 dark:placeholder:text-gray-800"
                                required
                            />
                        </div>
                        <button
